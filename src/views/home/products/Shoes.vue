<template>
  <div class="">
    <div class="sticky">
      <div class=" box">
      <form class="max-w-md  mx-auto mr-7 bg-gray-100 border">
        <label
          for="default-search"
          class="text-sm font-medium text-gray-400 sr-only dark:text-white"
          >Search</label
        >
        <div class="relative">
          <div
    ...
    <div class="py-10 px-4 button">
      <button
        ...
        v-if="companiesVisible < shoes.length"
